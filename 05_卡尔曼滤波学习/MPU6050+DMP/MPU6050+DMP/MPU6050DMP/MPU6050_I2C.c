...
{
  My_GPIO_Init(MPU6050_IIC_GPIO,MPU6050_IIC_SCL_Pin|MPU6050_IIC_SDA_Pin,GPIO_KL_OUT,GPIO_P_NO,GPIO_50MHz);//推挽输出 不拉 50m
...
{
	My_GPIO_Init(MPU6050_IIC_GPIO,MPU6050_IIC_SDA_Pin,GPIO_KL_OUT,GPIO_P_NO,GPIO_50MHz);//推挽输出 不拉 50m
}
