...
void freertos_demo(void)
{
    ...
    lcd_show_string(10, 118, 220, 16, 16, "Total Mem:", RED);
	lcd_show_string(10, 139, 220, 16, 16, "Free Mem:", RED);
	lcd_show_string(10, 160, 220, 16, 16, "Malloc Addr:", RED);
    ...
    while(1)
    {
		...
		switch(key_num){
			case KEY0_PRES:
			{
				...
				lcd_show_string(114, 160, 200, 16, 16, (char*)buf, BLUE);
				break;
			}
			case KEY1_PRES:
			{
