...
void task2(void *pvParameters)
{
	...
	TickType_t xListItem1Value = ListItem1.xItemValue;
	TickType_t xListItem2Value = ListItem2.xItemValue;
	TickType_t xListItem3Value = ListItem3.xItemValue;
	printf("xListItem1Value=%u\r\n",xListItem1Value);
	printf("xListItem2Value=%u\r\n",xListItem2Value);
	printf("xListItem3Value=%u\r\n",xListItem3Value);
	/* 第二步：打印列表和其他列表项的地址 */
